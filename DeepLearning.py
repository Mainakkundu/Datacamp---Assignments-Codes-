...
print(output)
-------------------------------------------------------
#WEIGHTS ADJUST(MANNUAL TO DEVELOP INTUATION) 
------------------------------------------------------
...
--------------------------------------------------------
# WEIGHTS UPDATING AND SLOPE CALCULATION
-------------------------------------------------------
...
-------------------------------------------
#-----------------------------------------
# KERAS FRAMEWORK MODEL BUILDING 
#----------------------------------------
...
#---------------------------------------------------------------------------------------------------------------------------------------------------
#EARLYSTOPPING  - IF YOU SPECIFY EPOCHS = 30 AND VALIDATION LOSS IS NOT IMPROVING THEN IT WILL SHOW FOR 2 STEPS CONSCUTIVELY ANS THEN STOP TRAINING 
#---------------------------------------------------------------------------------------------------------------------------------------------------
'''
...
#-------------------------------------------------------------------------
#HOW TO EXPERIMENT WITH WIDER NETWORK AND PLOT THE RESULT
#-------------------------------------------------------------------------
